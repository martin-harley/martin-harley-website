              ...
              <div>
                ...
                <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                  <div className="max-w-md mx-auto bg-white rounded-md shadow-sm overflow-hidden">
                    <div className="p-4">
                      <p className="text-sm font-medium text-gray-900">martinharley.vercel.app</p>
                ...
                <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                  <div className="max-w-md mx-auto bg-white rounded-md shadow-sm overflow-hidden">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-xs text-gray-400 mt-2">martinharley.vercel.app</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="border border-gray-200 rounded-lg p-4 bg-gray-50">
                  <div className="max-w-md mx-auto bg-white rounded-md shadow-sm overflow-hidden">
                    ...
                    <div className="p-4">
                      <p className="text-xs text-gray-500">martinharley.vercel.app</p>
                      <h4 className="text-base font-semibold mt-1">Martin Harley | Engineer & Developer</h4>
                      <p className="text-sm text-gray-500 mt-1">
                        Portfolio of Martin Harley, engineer building secure, reliable, and scalable digital infrastructure.
                      </p>
